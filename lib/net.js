...
// 分支解析：GitHub API 主路径，失败回退 git ls-remote（inbound-operations.md）。
...
/** 网络错误分类（inbound-operations.md）：not_found / rate_limited / unreachable / http_error。 */
...
/** 仓库 slug 规范化与校验（workshop-files.md 校验规则）。 */
