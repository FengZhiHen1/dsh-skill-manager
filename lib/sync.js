...
export async function reconcile({ root, state, apps, groups, skills, method = 'auto', save, workspaceIds, globalRootPath }) {
...
export async function health({ root, state, apps, groups, skills, workspaceIds, globalRootPath }) {
  const derived = deriveDesired({ state, apps, groups, skills, workspaceIds })
